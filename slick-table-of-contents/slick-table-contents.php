...
/**
    ...
    * Plugin URI:        https://github.com/stevenorechow/table-of-contents
    * Description:       Create a table of contents in any page or post using a custom Gutenberg block.
    * Version:           1.1
    * Requires at least: 5.2
    * Requires PHP:      7.2
    * Author:            Steven Orechow
    * Author URI:        https://stevenorechow.me/
